...
export class RoleAPI {
     ...
     */
    static async getRole(id: string): Promise<RoleInterface> {
     ...
     * @returns {Promise<RoleInterface>} 생성된 역할 정보
     */
    static async createRole(role: RoleInterface): Promise<RoleInterface> {
    ...
    /**
     * 역할 수정 API
     * @param {RoleInterface} authorization 수정할 역할 정보
     * @returns {Promise<RoleInterface>} 수정된 역할 정보
     */
    static async updateRole(role: RoleInterface): Promise<RoleInterface> {
     ...
     */
    static async deleteRole(id: string): Promise<RoleInterface> {
